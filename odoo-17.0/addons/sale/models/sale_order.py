...
class SaleOrder(models.Model):
    ...
    def _get_invoiced(self):
        ...
        for order in self:
            ...
            invoices_line = order.order_line.invoice_lines
            invoices = invoices_line.move_id.filtered(lambda r: r.move_type in ('out_invoice', 'out_refund'))
    ...
    def _compute_tax_totals(self):
        for order in self:
            order_lines = order.order_line.filtered(lambda x: not x.display_type)
            rs = self.env['account.tax']._prepare_tax_totals(
